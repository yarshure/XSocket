...
public struct XPort: CustomStringConvertible, Hashable, ExpressibleByIntegerLiteral {
    ...
    public init(integerLiteral value: XPort.IntegerLiteralType) {
...
public func == (left: XPort, right: XPort) -> Bool {
